...
//Creates a texture pool for each colour then assigns the model to each block. One set per colour.
    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        ...
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.WHITE_CONCRETE_BRICKS);
        ...
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.LIGHT_GRAY_CONCRETE_BRICKS);
        ...
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.GRAY_CONCRETE_BRICKS);
        ...
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.BLACK_CONCRETE_BRICKS);
        ...
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.BROWN_CONCRETE_BRICKS);
        ...
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.RED_CONCRETE_BRICKS);
        ...
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.ORANGE_CONCRETE_BRICKS);
        ...
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.YELLOW_CONCRETE_BRICKS);
        ...
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.LIME_CONCRETE_BRICKS);
        ...
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.GREEN_CONCRETE_BRICKS);
        ...
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.CYAN_CONCRETE_BRICKS);
        ...
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.LIGHT_BLUE_CONCRETE_BRICKS);
        ...
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.BLUE_CONCRETE_BRICKS);
        ...
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.PURPLE_CONCRETE_BRICKS);
        ...
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.MAGENTA_CONCRETE_BRICKS);
        ...
        blockStateModelGenerator.registerSimpleCubeAll(ModBlocks.PINK_CONCRETE_BRICKS);
    }
