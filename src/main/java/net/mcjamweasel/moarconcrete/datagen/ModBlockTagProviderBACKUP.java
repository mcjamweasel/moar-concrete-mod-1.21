...
public class ModBlockTagProviderBACKUP extends FabricTagProvider.BlockTagProvider {
    public ModBlockTagProviderBACKUP(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registriesFuture) {
