...
//Brick Slab functions
    public static final Block WHITE_CONCRETE_BRICK_SLAB = registerBlock("white_concrete_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_BRICKS).registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MoarConcrete.MOD_ID, "white_concrete_brick_slab")))));

    public static final Block LIGHT_GRAY_CONCRETE_BRICK_SLAB = registerBlock("light_gray_concrete_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_BRICKS).registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MoarConcrete.MOD_ID, "light_gray_concrete_brick_slab")))));

    public static final Block GRAY_CONCRETE_BRICK_SLAB = registerBlock("gray_concrete_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_BRICKS).registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MoarConcrete.MOD_ID, "gray_concrete_brick_slab")))));

    public static final Block BLACK_CONCRETE_BRICK_SLAB = registerBlock("black_concrete_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_BRICKS).registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MoarConcrete.MOD_ID, "black_concrete_brick_slab")))));

    public static final Block BROWN_CONCRETE_BRICK_SLAB = registerBlock("brown_concrete_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_BRICKS).registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MoarConcrete.MOD_ID, "brown_concrete_brick_slab")))));

    public static final Block RED_CONCRETE_BRICK_SLAB = registerBlock("red_concrete_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_BRICKS).registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MoarConcrete.MOD_ID, "red_concrete_brick_slab")))));

    public static final Block ORANGE_CONCRETE_BRICK_SLAB = registerBlock("orange_concrete_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_BRICKS).registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MoarConcrete.MOD_ID, "orange_concrete_brick_slab")))));

    public static final Block YELLOW_CONCRETE_BRICK_SLAB = registerBlock("yellow_concrete_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_BRICKS).registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MoarConcrete.MOD_ID, "yellow_concrete_brick_slab")))));

    public static final Block LIME_CONCRETE_BRICK_SLAB = registerBlock("lime_concrete_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_BRICKS).registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MoarConcrete.MOD_ID, "lime_concrete_brick_slab")))));

    public static final Block GREEN_CONCRETE_BRICK_SLAB = registerBlock("green_concrete_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_BRICKS).registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MoarConcrete.MOD_ID, "green_concrete_brick_slab")))));

    public static final Block CYAN_CONCRETE_BRICK_SLAB = registerBlock("cyan_concrete_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_BRICKS).registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MoarConcrete.MOD_ID, "cyan_concrete_brick_slab")))));

    public static final Block LIGHT_BLUE_CONCRETE_BRICK_SLAB = registerBlock("light_blue_concrete_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_BRICKS).registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MoarConcrete.MOD_ID, "light_blue_concrete_brick_slab")))));

    public static final Block BLUE_CONCRETE_BRICK_SLAB = registerBlock("blue_concrete_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_BRICKS).registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MoarConcrete.MOD_ID, "blue_concrete_brick_slab")))));

    public static final Block PURPLE_CONCRETE_BRICK_SLAB = registerBlock("purple_concrete_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_BRICKS).registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MoarConcrete.MOD_ID, "purple_concrete_brick_slab")))));

    public static final Block MAGENTA_CONCRETE_BRICK_SLAB = registerBlock("magenta_concrete_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_BRICKS).registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MoarConcrete.MOD_ID, "magenta_concrete_brick_slab")))));

    public static final Block PINK_CONCRETE_BRICK_SLAB = registerBlock("pink_concrete_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(Blocks.STONE_BRICKS).registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MoarConcrete.MOD_ID, "pink_concrete_brick_slab")))));
